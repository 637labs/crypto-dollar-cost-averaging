...
from .profile import LOCAL_NS, SANDBOX_NS, ProfileId
...
def _build_client_from_env() -> cbpro.AuthenticatedClient:
    ...
    return cbpro.AuthenticatedClient(api_key, b64secret, passphrase, api_url=api_url)


def _build_client_for_profile(profile: ProfileId) -> cbpro.AuthenticatedClient:
...
def get_client(profile: ProfileId) -> cbpro.AuthenticatedClient:
